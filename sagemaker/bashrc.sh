...
if [[ -z ${HOME} ]]; then
    ...
    echo -e "\033[95mwarning\033[0m: Home directory has not been claimed for bashrc."
fi
if [[ -z ${PROJECT} ]]; then
    # Focusing project name for SageMaker running should be defined.
    echo -e "\033[95mwarning\033[0m: SageMaker focusing project name in not defined in bashrc."
fi
if [[ -z ${STAGE} ]]; then
    # Focusing project working stage should be defined.
    echo -e "\033[95mwarning\033[0m: SageMaker focusing project working stage in not defined in bashrc."
fi
